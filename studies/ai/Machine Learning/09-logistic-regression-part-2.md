---
layout: page
title: "분류 Overfitting과 L2 정규화"
permalink: /studies/ai/machine-learning/09-logistic-regression-part-2/
sitemap: false
---

tags: #artificial-intelligence #machine-learning #classification #logistic-regression #regularization #l2

관련 노트: [선형분류와 Logistic Regression](08-logistic-regression-part-1.md), [SGD와 Online Learning](10-logistic-regression-part-3.md)
