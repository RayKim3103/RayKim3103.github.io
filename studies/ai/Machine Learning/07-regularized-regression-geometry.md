---
layout: page
title: "정규화회귀의 기하학과 Cross Validation"
permalink: /studies/ai/machine-learning/07-regularized-regression-geometry/
sitemap: false
---

tags: #artificial-intelligence #machine-learning #regularization #ridge #lasso #cross-validation

관련 노트: [Lasso Regression과 Feature Selection](06-lasso-regression.md), [선형분류와 Logistic Regression](08-logistic-regression-part-1.md)
