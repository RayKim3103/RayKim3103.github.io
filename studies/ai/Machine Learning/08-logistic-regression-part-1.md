---
layout: page
title: "선형분류와 Logistic Regression"
...
관련 노트: [정규화회귀의 기하학과 Cross Validation](07-regularized-regression-geometry.md), [분류 Overfitting과 L2 정규화](09-logistic-regression-part-2.md)
