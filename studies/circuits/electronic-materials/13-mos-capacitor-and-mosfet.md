---
layout: page
title: "13. MOS Capacitor and MOSFET - MOS 커패시터와 MOSFET"
...
- 이 문서는 **13. MOS Capacitor and MOSFET - MOS 커패시터와 MOSFET**를 다루며, 원자 결합, 결정, 양자역학, band theory에서 반도체 소자 물성까지 이어지는 전자재료의 기초를 정리한다.
...
- **13. MOS Capacitor and MOSFET - MOS 커패시터와 MOSFET**를 한 문장으로 설명하고, 관련 수식이나 회로/알고리즘/시스템 그림 없이도 핵심 흐름을 말할 수 있는가?

{% endraw %}

---

이전: [12. PN Diode Operation and Special Diodes - PN 다이오드](12-pn-diode-operation-and-special-diodes.md)
