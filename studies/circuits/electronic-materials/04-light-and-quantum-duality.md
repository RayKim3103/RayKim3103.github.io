---
layout: page
title: "04. Light and Quantum Duality - 빛과 양자 이중성"
...
다음: [Tunneling Blackbody Laser - 터널링 흑체 레이저](05-tunneling-blackbody-laser.md)
...
- 이 문서는 **04. Light and Quantum Duality - 빛과 양자 이중성**를 다루며, 원자 결합, 결정, 양자역학, band theory에서 반도체 소자 물성까지 이어지는 전자재료의 기초를 정리한다.
...
- **04. Light and Quantum Duality - 빛과 양자 이중성**를 한 문장으로 설명하고, 관련 수식이나 회로/알고리즘/시스템 그림 없이도 핵심 흐름을 말할 수 있는가?

{% endraw %}

---

이전: [03. Crystalline Amorphous and Fabrication - 결정질 비정질 공정](03-crystalline-amorphous-and-fabrication.md) · 다음: [05. Tunneling Blackbody Laser - 터널링 흑체 레이저](05-tunneling-blackbody-laser.md)
