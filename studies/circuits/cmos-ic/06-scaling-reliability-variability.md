...
permalink: /studies/circuits/cmos-ic/06-scaling-reliability-variability/
sitemap: false
---
...
- 이 문서는 **06. Scaling, Reliability, Variability**를 다루며, MOS device 특성에서 CMOS gate, delay, power, interconnect, sequential timing까지 회로와 물리 관점으로 연결한다.
...
- **06. Scaling, Reliability, Variability**를 한 문장으로 설명하고, 관련 수식이나 회로/알고리즘/시스템 그림 없이도 핵심 흐름을 말할 수 있는가?

{% endraw %}

---

이전: [05. Wire 모델과 Crosstalk](05-wire-crosstalk.md) · 다음: [06. MTCMOS와 Power Gating 보강](06-1-mtcmos-and-power-gating.md)
