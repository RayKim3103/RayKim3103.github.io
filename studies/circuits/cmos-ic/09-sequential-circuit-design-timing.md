---
layout: page
title: "09. Sequential Circuit Design과 Timing"
permalink: /studies/circuits/cmos-ic/09-sequential-circuit-design-timing/
sitemap: false
---
...
- 이 문서는 **09. Sequential Circuit Design과 Timing**를 다루며, MOS device 특성에서 CMOS gate, delay, power, interconnect, sequential timing까지 회로와 물리 관점으로 연결한다.
...
- **09. Sequential Circuit Design과 Timing**를 한 문장으로 설명하고, 관련 수식이나 회로/알고리즘/시스템 그림 없이도 핵심 흐름을 말할 수 있는가?

{% endraw %}

---

이전: [08. Datapaths: 가산기, 시프터, 곱셈기](08-datapaths.md)
