---
layout: page
title: "05. Wire 모델과 Crosstalk"
permalink: /studies/circuits/cmos-ic/05-wire-crosstalk/
sitemap: false
---
...
- 이 문서는 **05. Wire 모델과 Crosstalk**를 다루며, MOS device 특성에서 CMOS gate, delay, power, interconnect, sequential timing까지 회로와 물리 관점으로 연결한다.
...
- **05. Wire 모델과 Crosstalk**를 한 문장으로 설명하고, 관련 수식이나 회로/알고리즘/시스템 그림 없이도 핵심 흐름을 말할 수 있는가?

{% endraw %}

---

이전: [04. CMOS 전력소모와 저전력기법](04-power-cmos.md) · 다음: [06. Scaling, Reliability, Variability](06-scaling-reliability-variability.md)
