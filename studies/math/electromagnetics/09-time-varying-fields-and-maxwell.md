...
- 이 문서는 **09. 시간 변화장과 맥스웰 방정식**를 다루며, 벡터해석을 바탕으로 전기장, 자기장, 물질 경계조건, Maxwell 방정식을 연결해 전자기 현상을 설명한다.
...
- **09. 시간 변화장과 맥스웰 방정식**를 한 문장으로 설명하고, 관련 수식이나 회로/알고리즘/시스템 그림 없이도 핵심 흐름을 말할 수 있는가?
