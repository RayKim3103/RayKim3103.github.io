---
layout: page
title: "00. Project Report - Rayleigh Fading 음성 통신 구현"
permalink: /studies/signals/digital-communications/00-project-report-rayleigh-fading/
sitemap: false
---
...
- 이 문서는 **00. Project Report - Rayleigh Fading 음성 통신 구현**를 다루며, baseband/bandpass 전송, 변조, 잡음, BER, 채널 부호, fading/equalization을 통신 시스템 관점에서 연결한다.
...
- **00. Project Report - Rayleigh Fading 음성 통신 구현**를 한 문장으로 설명하고, 관련 수식이나 회로/알고리즘/시스템 그림 없이도 핵심 흐름을 말할 수 있는가?

{% endraw %}

---

이전: [00. Final Project - 디지털 통신 시스템 시뮬레이션](00-final-project.md) · 다음: [01. Basic of Communications - 디지털 통신 개요](01-basic-of-communications.md)
