---
layout: page
title: "07. Channel Coding Supplement - Entropy와 Shannon Limit"
permalink: /studies/signals/digital-communications/07-channel-coding-supplement-entropy-shannon-limit/
sitemap: false
---
...
- 이 문서는 **07. Channel Coding Supplement - Entropy와 Shannon Limit**를 다루며, baseband/bandpass 전송, 변조, 잡음, BER, 채널 부호, fading/equalization을 통신 시스템 관점에서 연결한다.
...
- **07. Channel Coding Supplement - Entropy와 Shannon Limit**를 한 문장으로 설명하고, 관련 수식이나 회로/알고리즘/시스템 그림 없이도 핵심 흐름을 말할 수 있는가?

{% endraw %}

---

이전: [06. Channel Coding - 오류 제어 부호](06-channel-coding.md) · 다음: [08. QPSK vs 16QAM - 대역폭과 BER 비교](08-qpsk-vs-16qam-ber.md)
