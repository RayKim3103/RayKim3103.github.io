---
layout: page
title: "04. Noise and Decision - 잡음과 최적 검출"
permalink: /studies/signals/digital-communications/04-noise-and-decision/
sitemap: false
---
...
- 이 문서는 **04. Noise and Decision - 잡음과 최적 검출**를 다루며, baseband/bandpass 전송, 변조, 잡음, BER, 채널 부호, fading/equalization을 통신 시스템 관점에서 연결한다.
...
- **04. Noise and Decision - 잡음과 최적 검출**를 한 문장으로 설명하고, 관련 수식이나 회로/알고리즘/시스템 그림 없이도 핵심 흐름을 말할 수 있는가?

{% endraw %}

---

이전: [03. Bandpass Transmission - 디지털 변조와 검파](03-bandpass-transmission.md) · 다음: [05. Error Performance - Bandpass BER 성능](05-error-performance-bandpass-ber.md)
