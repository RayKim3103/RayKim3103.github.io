---
layout: page
title: "02. Baseband Transmission - 샘플링 PCM Quantization ISI"
permalink: /studies/signals/digital-communications/02-baseband-transmission-pcm-quantization-isi/
sitemap: false
---
...
- 이 문서는 **02. Baseband Transmission - 샘플링 PCM Quantization ISI**를 다루며, baseband/bandpass 전송, 변조, 잡음, BER, 채널 부호, fading/equalization을 통신 시스템 관점에서 연결한다.
...
- **02. Baseband Transmission - 샘플링 PCM Quantization ISI**를 한 문장으로 설명하고, 관련 수식이나 회로/알고리즘/시스템 그림 없이도 핵심 흐름을 말할 수 있는가?

{% endraw %}

---

이전: [01. Basic of Communications - 디지털 통신 개요](01-basic-of-communications.md) · 다음: [03. Bandpass Transmission - 디지털 변조와 검파](03-bandpass-transmission.md)
