...
permalink: /studies/signals/dsp/12-dft-and-fft/
sitemap: false
---
...
- 이 문서는 **12. DFT and FFT**를 다루며, 이산시간 신호를 z-domain, frequency domain, filter structure, FFT 관점에서 분석하고 설계한다.
...
- **12. DFT and FFT**를 한 문장으로 설명하고, 관련 수식이나 회로/알고리즘/시스템 그림 없이도 핵심 흐름을 말할 수 있는가?

{% endraw %}

---

이전: [11. Digital Filter Design](11-digital-filter-design.md) · 다음: [13. 2D DSP Overview](13-2d-dsp-overview.md)
