...
permalink: /studies/signals/dsp/03-review-of-signals-and-systems/
sitemap: false
---
...
- 이 문서는 **03. Review of Signals and Systems**를 다루며, 이산시간 신호를 z-domain, frequency domain, filter structure, FFT 관점에서 분석하고 설계한다.
...
- **03. Review of Signals and Systems**를 한 문장으로 설명하고, 관련 수식이나 회로/알고리즘/시스템 그림 없이도 핵심 흐름을 말할 수 있는가?

{% endraw %}

---

이전: [02. DSP Introduction](02-dsp-introduction.md) · 다음: [04. Sampling Rate Change](04-sampling-rate-change.md)
