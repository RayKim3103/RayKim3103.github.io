...
**Trace (n=10)**: 초기값 `t=10`에서 시작하면

| 반복 | `t` | `n/t` | `|t - n/t|` |
|---:|---:|---:|---:|
| 0 | 10.000000 | 1.000000 | 9.0 |
| 1 | 5.500000 | 1.818182 | 3.68 |
| 2 | 3.659091 | 2.732818 | 0.926 |
| 3 | 3.195954 | 3.129457 | 0.0665 |
| 4 | 3.162705 | 3.161856 | 0.00085 |

실제 $$\sqrt{10}\approx3.162278$$에 4번의 반복만에 소수점 셋째 자리까지 수렴한다 — 매 단계마다 오차가 거의 제곱으로 줄어드는 **이차 수렴(quadratic convergence)** 덕분이다.
...
- `n=10`에서 Newton-Raphson 첫 두 반복을 손으로 계산할 수 있는가?
- `while`과 `do-while`의 차이를 조건이 처음부터 거짓인 입력으로 설명할 수 있는가?
- `assert`와 `throw`/`catch`의 용도 차이(개발 중 가정 검증 vs 실행 중 예외 처리)를 설명할 수 있는가?
