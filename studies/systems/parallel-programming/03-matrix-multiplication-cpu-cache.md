...
permalink: /studies/systems/parallel-programming/03-matrix-multiplication-cpu-cache/
sitemap: false
---
...
- 이 문서는 **03. Matrix Multiplication - CPU Cache와 병렬 행렬곱**를 다루며, CPU thread, CUDA, Triton, MPI를 통해 병렬 하드웨어에서 성능을 끌어내는 방법을 배운다.
...
- **03. Matrix Multiplication - CPU Cache와 병렬 행렬곱**를 한 문장으로 설명하고, 관련 수식이나 회로/알고리즘/시스템 그림 없이도 핵심 흐름을 말할 수 있는가?

{% endraw %}

---

이전: [02. Thread Programming - C++ Thread와 동기화](02-thread-programming-c.md) · 다음: [04. Intro to CUDA - CUDA 프로그래밍 모델](04-intro-to-cuda.md)
