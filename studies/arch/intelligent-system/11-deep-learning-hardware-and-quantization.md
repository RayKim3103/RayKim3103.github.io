...
permalink: /studies/arch/intelligent-system/11-deep-learning-hardware-and-quantization/
sitemap: false
---
...
- 이 문서는 **11. Deep Learning Hardware and Quantization**를 다루며, FPGA/SoC 위에서 디지털 회로, 메모리, AXI, 영상/AI 하드웨어를 구현하는 흐름을 익힌다.
...
- **11. Deep Learning Hardware and Quantization**를 한 문장으로 설명하고, 관련 수식이나 회로/알고리즘/시스템 그림 없이도 핵심 흐름을 말할 수 있는가?

{% endraw %}

---

이전: [10. Computer Vision, Neural Networks, and CNN](10-computer-vision-neural-networks-and-cnn.md)
