...
permalink: /studies/arch/intelligent-system/09-ps-pl-axi-pynq-and-ila/
sitemap: false
---
...
> 이전: [UART and Memory Loopback](08-uart-and-memory-loopback.md)
> 다음: [Computer Vision, Neural Networks, and CNN](10-computer-vision-neural-networks-and-cnn.md)
...
- 이 문서는 **09. PS/PL, AXI, PYNQ, and ILA**를 다루며, FPGA/SoC 위에서 디지털 회로, 메모리, AXI, 영상/AI 하드웨어를 구현하는 흐름을 익힌다.
...
- **09. PS/PL, AXI, PYNQ, and ILA**를 한 문장으로 설명하고, 관련 수식이나 회로/알고리즘/시스템 그림 없이도 핵심 흐름을 말할 수 있는가?

{% endraw %}

---

이전: [08. UART and Memory Loopback](08-uart-and-memory-loopback.md) · 다음: [10. Computer Vision, Neural Networks, and CNN](10-computer-vision-neural-networks-and-cnn.md)
