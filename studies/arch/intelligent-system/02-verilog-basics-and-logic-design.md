...
permalink: /studies/arch/intelligent-system/02-verilog-basics-and-logic-design/
sitemap: false
---
...
> 이전: [Vivado Installation and Basic Flow](01-vivado-installation-and-basic-flow.md)
> 다음: [FSM and Sequential System Design](03-fsm-and-sequential-system-design.md)
...
- 이 문서는 **02. Verilog Basics and Logic Design**를 다루며, FPGA/SoC 위에서 디지털 회로, 메모리, AXI, 영상/AI 하드웨어를 구현하는 흐름을 익힌다.
...
- **02. Verilog Basics and Logic Design**를 한 문장으로 설명하고, 관련 수식이나 회로/알고리즘/시스템 그림 없이도 핵심 흐름을 말할 수 있는가?

{% endraw %}

---

이전: [01. Vivado Installation and Basic Flow](01-vivado-installation-and-basic-flow.md) · 다음: [03. FSM and Sequential System Design](03-fsm-and-sequential-system-design.md)
