...
permalink: /studies/arch/intelligent-system/06-fpga-bram-and-dpram-wrapper/
sitemap: false
---
...
> 이전: [SRAM and Memory Controller](05-sram-and-memory-controller.md)
> 다음: [FIFO and Line Buffer](07-fifo-and-line-buffer.md)
...
- 이 문서는 **06. FPGA BRAM and DPRAM Wrapper**를 다루며, FPGA/SoC 위에서 디지털 회로, 메모리, AXI, 영상/AI 하드웨어를 구현하는 흐름을 익힌다.
...
- **06. FPGA BRAM and DPRAM Wrapper**를 한 문장으로 설명하고, 관련 수식이나 회로/알고리즘/시스템 그림 없이도 핵심 흐름을 말할 수 있는가?

{% endraw %}

---

이전: [05. SRAM and Memory Controller](05-sram-and-memory-controller.md) · 다음: [07. FIFO and Line Buffer](07-fifo-and-line-buffer.md)
