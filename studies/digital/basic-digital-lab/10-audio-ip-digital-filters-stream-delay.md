---
layout: page
title: "10. Audio IP, Digital Filters, Stream Delay"
permalink: /studies/digital/basic-digital-lab/10-audio-ip-digital-filters-stream-delay/
sitemap: false
---
...
- 이 문서는 **10. Audio IP, Digital Filters, Stream Delay**를 다루며, Verilog와 FPGA 보드 실습을 통해 조합논리, 순차논리, SoC, 인터럽트, 디스플레이/오디오 IP를 구현한다.
...
- **10. Audio IP, Digital Filters, Stream Delay**를 한 문장으로 설명하고, 관련 수식이나 회로/알고리즘/시스템 그림 없이도 핵심 흐름을 말할 수 있는가?

{% endraw %}

---

이전: [09. AMBA, AHB, APB, Memory Transfer](09-amba-ahb-apb-memory-transfer.md) · 다음: [11. HDMI, TMDS, LCD Display](11-hdmi-tmds-lcd-display.md)
