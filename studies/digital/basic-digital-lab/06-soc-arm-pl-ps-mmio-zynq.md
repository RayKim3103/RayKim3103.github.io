---
layout: page
title: "06. Zynq SoC, ARM, PL/PS, MMIO"
permalink: /studies/digital/basic-digital-lab/06-soc-arm-pl-ps-mmio-zynq/
sitemap: false
---
...
- 이 문서는 **06. Zynq SoC, ARM, PL/PS, MMIO**를 다루며, Verilog와 FPGA 보드 실습을 통해 조합논리, 순차논리, SoC, 인터럽트, 디스플레이/오디오 IP를 구현한다.
...
- **06. Zynq SoC, ARM, PL/PS, MMIO**를 한 문장으로 설명하고, 관련 수식이나 회로/알고리즘/시스템 그림 없이도 핵심 흐름을 말할 수 있는가?

{% endraw %}

---

이전: [05. FSM과 Traffic Light Controller](05-fsm-traffic-light.md) · 다음: [07. Polling, Interrupt, Timer](07-polling-interrupt-timer.md)
